# This Makefile is for the URI::Find::UTF8 extension to perl.
#
...
#     ABSTRACT => q[Finds URI from arbitrary text containing UTF8 raw characters in its path]
#     AUTHOR => q[Tatsuhiko Miyagawa <miyagawa@bulknews.net>]
#     DIR => []
#     DISTNAME => q[URI-Find-UTF8]
#     NAME => q[URI::Find::UTF8]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { URI::Find=>q[0], Test::More=>q[0], URI::Escape=>q[0], Encode=>q[0] }
#     VERSION => q[0.01]
...
FULLEXT = URI/Find/UTF8
BASEEXT = UTF8
PARENT_NAME = URI::Find
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/URI/Find/UTF8.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/URI/Find
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/URI/Find
...
TO_INST_PM = lib/URI/Find/UTF8.pm

PM_TO_BLIB = lib/URI/Find/UTF8.pm \
...
DISTNAME = URI-Find-UTF8
DISTVNAME = URI-Find-UTF8-0.01
...
manifypods : pure_all  \
	lib/URI/Find/UTF8.pm \
	lib/URI/Find/UTF8.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/URI/Find/UTF8.pm $(INST_MAN3DIR)/URI::Find::UTF8.$(MAN3EXT) 
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Finds URI from arbitrary text containing UTF8 raw characters in its path</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Tatsuhiko Miyagawa &lt;miyagawa@bulknews.net&gt;</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="URI-Find" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/URI/Find/UTF8.pm blib/lib/URI/Find/UTF8.pm 
